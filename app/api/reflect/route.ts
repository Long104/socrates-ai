...
import { REFLECT_SYSTEM_PROMPT } from "@/lib/prompts";
import type { ReflectRequest, ReflectResponse } from "@/lib/types";
...
export async function POST(request: Request) {
  try {
    ...
    const systemPrompt = REFLECT_SYSTEM_PROMPT.replace(
      "{fact}",
      body.assumption.fact
    )
