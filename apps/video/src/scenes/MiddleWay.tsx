...
const MW =
  "Capitalism isn't purely evil or purely good. It's a system with real costs and real benefits. The question is how to regulate its excesses while preserving its capacity to lift people out of poverty.";
...
function NodeCard({
  ...
  color,
  children,
}: { title: string; label: string; color: string; children: React.ReactNode }) {
  return (
    <div
      style={{
        backgroundColor: "rgba(28,26,38,0.95)",
        border: `1px solid ${color}${label === "Resolved" ? "55" : "15"}`,
        borderRadius: 8,
        overflow: "hidden",
      }}
    >
...
export function MiddleWay() {
  ...
  const tagO = interpolate(frame, [mwDelay + 25, mwDelay + 50], [0, 1], {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#0e1210" }}>
      ...
      >
        ...
        <div
          style={{
            opacity: interpolate(n0, [0, 1], [0, 1]),
            width: 2,
            height: 16,
            backgroundColor: "rgba(100,200,130,0.3)",
          }}
        />
        ...
        <div
          style={{ opacity: mwO, width: 2, height: 16, backgroundColor: "rgba(200,220,180,0.3)" }}
        />
        ...
        <div style={{ opacity: mwO, transform: `scale(${mwScale})`, filter: `blur(${mwBlur}px)` }}>
          ...
          <div
            style={{
              ...
              zIndex: 1,
              width: 500,
              backgroundColor: "rgba(18,28,20,0.95)",
              border: "2px solid rgba(200,220,180,0.25)",
              borderRadius: 10,
              boxShadow: "0 0 80px rgba(200,220,180,0.06)",
            }}
          >
            <div
              style={{
                ...
                alignItems: "center",
                padding: "8px 18px",
                borderBottom: "1px solid rgba(200,220,180,0.08)",
                backgroundColor: "rgba(200,220,180,0.03)",
              }}
            >
              <span
                style={{
